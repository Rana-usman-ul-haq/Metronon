...
contract Metronon is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0xdA792ad08245b44D791A89C51A5E889C5422981b); // tax wallet
    ...
    string private constant _name = unicode"Metronon"; // name
    string private constant _symbol = unicode"Metronon"; // symbol
